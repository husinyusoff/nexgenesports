...
public class LoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try (Connection c = DBConnection.getConnection()) {
            ...
            switch (baseRole) {
                case "athlete":
                    storedRoles.add("athlete");
                    break;
                case "executive_council":
                    storedRoles.addAll(List.of("executive_council", "athlete"));
                    break;
                case "high_council":
                    storedRoles.addAll(
                            List.of("high_council", "executive_council", "athlete"));
                    break;
                case "referee":
                    storedRoles.add("referee");
                    break;
                default:
                    resp.sendRedirect(req.getContextPath() + "/login.jsp?error=badcreds");
                    return;
            ...
            switch (chosenRole) {
                case "athlete":
                    effectiveRoles.add("athlete");
                    break;
                case "executive_council":
                    effectiveRoles.addAll(List.of("executive_council", "athlete"));
                    break;
                case "high_council":
