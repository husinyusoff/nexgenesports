...
public class ManageMembershipPassServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            // If nextSession is null, initialize it with default values to prevent null pointer exceptions
            if (nextSession == null) {
                nextSession = new HashMap<>();
                nextSession.put("sessionId", "N/A");
                nextSession.put("sessionName", "No next session available");
                nextSession.put("fee", BigDecimal.ZERO);
            }
            ...
            try (PreparedStatement ps = conn.prepareStatement(
                    ...
                    + "  FROM monthlygamingpasstiers ORDER BY tierId ASC"); ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
