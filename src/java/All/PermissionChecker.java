...
public class PermissionChecker {
     ...
     *
     * @param effectiveRoles The user’s list of inherited roles (e.g.
     * ["high_council","executive_council","athlete"])
     * @param chosenRole The exact role the user picked at login (e.g.
     * "athlete", "high_council", "superadmin")
    ...
    public static boolean hasAccess(
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement psPage = conn.prepareStatement(PAGE_SQL)) {
        ...
        try (Connection conn = DBConnection.getConnection(); PreparedStatement psPerm = conn.prepareStatement(PERM_SQL)) {
